...
void MuStoppedSteppingAction::UserSteppingAction(const G4Step* step)
{
  ...
  if (!fTheLogicalVolumeWithEnergyRecord) { 
   ...
   //G4cout<<" ----------fTheLogicalVolumeWithEnergyRecord:  : "<< fTheLogicalVolumeWithEnergyRecord<<G4endl;   
  ...
  G4LogicalVolume* volume 
   ...
   //G4cout<<"track->GetTrackStatus(): "<<track->GetTrackStatus()<<G4endl; 
   //G4cout<<" fTheLogicalVolumeWithEnergyRecord->GetName(): "<< fTheLogicalVolumeWithEnergyRecord->GetName()<<G4endl;   

  //G4StepPoint * preStepPoint = step->GetPreStepPoint();
  //G4ThreeVector Position = preStepPoint->GetPosition();
  //G4cout<<"CapturedPosition: "<<Position<<G4endl;
...
if (volume != fTheLogicalVolumeWithEnergyRecord) return;
  ...
  //G4cout<<"edepStep in Stepping Action: "<<G4BestUnit(edepStep, "Energy")  <<G4endl;
