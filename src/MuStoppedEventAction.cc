...
{   
 ...
 // fRunAction->AddEdep(fEdep);
  ...
  //if(fEdep!=0)
  //G4cout<<"fEdep in Event Action: "<<G4BestUnit(fEdep,"Energy")<<G4endl;
 
  totalEnergyDeposit = fEdep;
        // Store the total deposited energy in the ntuple for analysis
        G4AnalysisManager* analysisManager = G4AnalysisManager::Instance();
        analysisManager->FillNtupleDColumn(7, 0, totalEnergyDeposit / keV);  // Save the total energy
