...
//------ Ntuple 6 saved position and angular information of the produced gamma in cubic target
  analysisManager->CreateNtuple("UniformGamma", "Uniform Gamma information");
  analysisManager->CreateNtupleDColumn("E");    //column 0
  analysisManager->CreateNtupleDColumn("Phi");    //column 1
  analysisManager->CreateNtupleDColumn("Theta");    //column 2
  analysisManager->CreateNtupleDColumn("CosTheta");    //column 3
...
//------ Ntuple 7 saved the energy deposited in logicalAndyDetector
  analysisManager->CreateNtuple("energydeposited", "energy deposited in sensitive detector");
  analysisManager->CreateNtupleDColumn("E");    //column 0
